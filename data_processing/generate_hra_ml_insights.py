...
Reads the CloudFront parquet logs and generates JSON outputs in public/data/hra
...
def _latest_parquet(directory: str) -> str:
    import glob, os
...
def parse_args() -> argparse.Namespace:
    ...
    parser.add_argument(
        "--input-parquet",
        default=_latest_parquet("data/hra") or "data/hra/2026-04-06_hra-logs.parquet",
        help="Path to source parquet log file",
    )
    parser.add_argument(
        "--output-dir",
        default="public/data/hra",
