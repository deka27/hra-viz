...
Outputs public/data/hra/publications.json for the analytics dashboard.
Free API, no auth key needed — just requires tool + email params.

Usage:
    python data_processing/fetch_publications.py
    python data_processing/fetch_publications.py --out public/data/hra
"""
...
def main():
    ...
    parser.add_argument("--out", default="public/data/hra", help="Output directory")
