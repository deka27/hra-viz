      ...
      <div className="flex flex-col gap-3">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
          ...
          <div className="bg-zinc-900 border border-red-500/20 rounded-xl p-5 flex flex-col gap-3">
            ...
            <div className="flex flex-col gap-1">
              <p className="text-sm font-semibold text-zinc-100">Export / Download Not Measurable</p>
            ...
            <div className="mt-auto pt-3 border-t border-zinc-800">
              ...
              <p className="text-xs text-zinc-400">
                Add an explicit <code className="text-zinc-300">download/export</code> analytics event first.
