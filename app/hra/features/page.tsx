...
import cdeTabsData from "../../../public/data/hra/cde_tabs.json";
import topPathsByEvent from "../../../public/data/hra/top_paths_by_event.json";
import sidebarActions from "../../../public/data/hra/sidebar_actions.json";
import orgSelections from "../../../public/data/hra/organ_selections.json";
      ...
      >
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
          <div className="lg:col-span-2">
            <RUIKeyboardChart data={topPathsByEvent as Record<string, { path: string; count: number }[]>} />
          </div>
