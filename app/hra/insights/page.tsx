...
import kgErrorRateData from "../../../public/data/hra/kg_error_rate.json";
import toolReturnRateData from "../../../public/data/hra/tool_return_rate.json";
import crossToolSessions from "../../../public/data/hra/cross_tool_sessions.json";
import opacityData from "../../../public/data/hra/opacity_interactions.json";
import cdeWorkflowData from "../../../public/data/hra/cde_workflow.json";
import spatialSearch from "../../../public/data/hra/spatial_search.json";
import geoData from "../../../public/data/hra/geo_distribution.json";
import sessionDepth from "../../../public/data/hra/session_depth.json";
import navClicks from "../../../public/data/hra/nav_clicks.json";
...
import topUiPaths from "../../../public/data/hra/top_ui_paths.json";
...
const otherFtuInTop20 = uiPathArr.slice(0, 20).filter(d => d.path.startsWith("hra-pop-visualizer.") && d.path !== "hra-pop-visualizer.bar-graph").length;
...
const INSIGHT_CHARTS: Record<number, React.ReactNode> = {
  ...
  10: <KeyboardAsymmetryChart compact topPathsByEvent={topPathsByEvent as Record<string, { path: string; count: number }[]>} />,
  18: <ReferrerEcosystemChart compact referrersData={referrers as { name: string; value: number }[]} />,
  19: <NavClicksChart compact navClicksData={navClicks as { label: string; count: number }[]} />,
  20: <SessionDepthChart compact data={sessionDepth as { depth: string; sessions: number }[]} />,
};
...
const insights = [
  ...
  },
  {
    ...
    implication:
      `The spatial search onboarding has a ${spatialContRate}% continuation rate. Simplifying organ selection or adding 'Quick Search' presets for common organs (kidney, heart) could significantly increase completion.`,
    data: [
  ...
  },
  {
    ...
    dot: "bg-red-400",
    tag: "Quality Issue",
    title: `${kgErrPct + euiErrPct}% of all errors come from 3 fixable bugs`,
  ...
  },
  {
    ...
    dot: "bg-fuchsia-500",
    tag: "UX Insight",
    title: `${cdeBypassPct}% of CDE users skip the landing page entirely`,
  ...
  },
  {
    ...
    data: [
      ...
      { label: "Other FTU elements in top 20", value: otherFtuInTop20 === 0 ? "None" : `${otherFtuInTop20}` },
    ],
  },
