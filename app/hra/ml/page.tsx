...
import forecastData from "../../../public/data/hra/forecast_tool_visits.json";
import detectedEvents from "../../../public/data/hra/detected_events.json";
import userSegments from "../../../public/data/hra/user_segments.json";
import returnProbability from "../../../public/data/hra/return_probability.json";
import transitionMatrix from "../../../public/data/hra/transition_matrix.json";
import featureCooccurrence from "../../../public/data/hra/feature_cooccurrence.json";
import botScores from "../../../public/data/hra/bot_scores.json";
import errorClusters from "../../../public/data/hra/error_clusters.json";
import suspiciousCountries from "../../../public/data/hra/suspicious_countries.json";
import pipelineMetadata from "../../../public/data/hra/ml_pipeline_metadata.json";
import cohortRetention from "../../../public/data/hra/cohort_retention.json";
...
export default function MLPage() {
  ...
  const churnRaw = returnProbability as { metrics?: Partial<ChurnMetrics>; probability_buckets?: ChurnBucket[]; top_positive_features?: Array<{ feature: string; weight: number }>; top_negative_features?: Array<{ feature: string; weight: number }>; notes?: string };
  const defaultMetrics: ChurnMetrics = { sessions_used: 0, positive_rate: 0, accuracy: 0, precision: 0, recall: 0, f1: 0, roc_auc: 0 };
  const churn = { ...churnRaw, metrics: { ...defaultMetrics, ...churnRaw.metrics } };
  ...
  const botRaw = botScores as { metrics?: Partial<BotMetrics>; feature_importance?: Array<{ feature: string; importance: number }>; notes?: string };
  const defaultBotMetrics: BotMetrics = { accuracy: 0, precision: 0, recall: 0, f1: 0, roc_auc: 0, positive_rate: 0, rows_train: 0, rows_test: 0 };
  const bot = { ...botRaw, metrics: { ...defaultBotMetrics, ...botRaw.metrics } };
