...
import cdeWorkflow from "../../../public/data/hra/cde_workflow.json";
...
import crossToolRecommendations from "../../../public/data/hra/cross_tool_recommendations.json";
...
export default function OpportunitiesPage() {
  return (
    <div className="flex flex-col gap-8">
      ...
      >
        <ToolTransitionFlowChart transitionData={transitionMatrix} totalToolVisits={totalToolVisits} />
